...
public class UIMapArrow : MonoBehaviour
{
	...
	Transform mCam;
	Transform mCamera { get { if (mCam == null) mCam = Camera.mainCamera.transform; return mCam; } }
	...
	public void UpdatePosition()
	{
		...
		if (UIMiniMap.instance.target == null && Camera.mainCamera != null)
		{
			if (mTarget != Camera.mainCamera.transform) mTarget = Camera.mainCamera.transform;
		}
